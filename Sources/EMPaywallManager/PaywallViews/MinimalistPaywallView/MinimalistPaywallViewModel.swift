//
//  MinimalistPaywallViewModel.swift
//  EMPaywallManager
//
...
final public class MinimalistPaywallViewModel: ObservableObject, PaywallViewModelProtocol {
    ...
    init(model: PaywallModel,
        ...
        self.selectedFeature = model.features.first ?? Feature.fallbackWithLogging(reason: "MinimalistPaywallView: No features available")
    }
}
